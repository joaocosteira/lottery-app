...
const Home: NextPage = () => {
  ...
  const onWithdrawWinnings = async () => {
    ...
    try{
      ...
      toast.success("You Withdrew the winnings successfully!",{
        id : notification
      });
  ...
  return (
    <div className="bg-[#091B18] min-h-screen flex flex-col">
      ...
      <div className='flex-1'>
          ...
          { winnings > 0 && (
            <div className="max-w-m md:max-w-2xl lg:max-w-4xl mx-auto mt-5">
              <button
              ...
              >
                ...
                <p className='font-semibold'>Total Winnings: {ethers.utils.formatEther(winnings.toString())}{" "}{currency}</p>
                <br/>
            ...
            <div className="stats-container space-y-2">
              <div className="stats-container">
                ...
                <button
                  ...
                  onClick={handleClick}
                  className='mt-5 w-full bg-gradient-to-br from-orange-500 to-emerald-600 px-10 py-5 rounded-md text-white font-semibold shadow-xl disabled:from-gray-600 disabled:to-gray-600 disabled:text-gray-100 disabled:cursor-not-allowed'
                >
        ...
        <footer className='border-t border-emerald-500/20 flex items-center text-white justify-between p-5'>
            <img
              className='h-10 w-10 filter hue-rotate-90 opacity-20'
              src="/login_logo.png"
              alt=""
            />
            <p className='text-xs text-emerald-900 pl-5'>Cillum aliquip sit dolor culpa cillum do aliqua dolore tempor qui nostrud tempor sint laborum. Elit non adipisicing duis cillum. Cupidatat labore culpa labore adipisicing qui commodo adipisicing labore incididunt ullamco veniam amet officia. Ullamco aliqua officia cillum exercitation sint. Proident velit quis amet ipsum quis magna sit ullamco duis esse. Ad ad velit duis eiusmod duis deserunt ut. Elit et est officia ipsum eiusmod eiusmod reprehenderit.Incididunt tempor nisi do nisi consectetur magna eu mollit enim reprehenderit non ullamco. Consectetur ad commodo ullamco laboris cupidatat nisi mollit eiusmod anim elit et consectetur magna. Excepteur aliquip veniam nostrud enim anim consectetur adipisicing eiusmod Lorem. Laborum laborum labore et dolor fugiat nostrud est labore. Veniam mollit nisi adipisicing duis ipsum deserunt cillum cillum adipisicing proident labore mollit nostrud. Magna laboris amet ad officia occaecat et Lorem nostrud ipsum eu.</p>
        </footer>
    </div>
  )
